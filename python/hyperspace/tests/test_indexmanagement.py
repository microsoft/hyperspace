...
class HyperspaceIndexManagementTests(HyperspaceTestCase):
    ...
    def test_index_delete(self):
        idx_config = IndexConfig('idx2', ['name'], IncludedColumnsConfig(['age'], []))
        self.hyperspace.createIndex(self.df, idx_config)
    ...
    def test_index_restore(self):
        idx_config = IndexConfig('idx3', ['name'], IncludedColumnsConfig(['age'], []))
        self.hyperspace.createIndex(self.df, idx_config)
    ...
    def test_index_vacuum(self):
        idx_config = IndexConfig('idx4', ['name'], IncludedColumnsConfig(['age'], []))
        self.hyperspace.createIndex(self.df, idx_config)
