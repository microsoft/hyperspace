...
import com.microsoft.hyperspace.index.rules.{FilterIndexRule, HyperspaceOneRule, JoinIndexRule}
...
package object hyperspace {
  ...
  private val hyperspaceOptimizationRuleBatch = HyperspaceOneRule :: Nil
  // JoinIndexRule :: FilterIndexRule :: Nil
